...
function get_payment_html(){
    ...
    var c_backurl = chrome.runtime.getURL("helper/order_check.html?transfer_no=");
    clearInterval(last_order_info.last_task_id);
    MZK_getJSON_DATA("chromeext/mzkpay/submit_order", {product_id:product_id,payment_method:payment_method,c_backurl:c_backurl}, function (data) {
...
function get_pay_result(){
    MZK_getJSON_DATA("chromeext/payment/get_pay_status", {transfer_no:last_order_info.transfer_no}, function (data) {
        if (data.result == "ok") {
