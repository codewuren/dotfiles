(()=>{"use strict";var e={4783:function(e,p,a){var r=this&&this.__createBinding||(Object.create?function(e,p,a,r){void 0===r&&(r=a);var l=Object.getOwnPropertyDescriptor(p,a);l&&!("get"in l?!p.__esModule:l.writable||l.configurable)||(l={enumerable:!0,get:function(){return p[a]}}),Object.defineProperty(e,r,l)}:function(e,p,a,r){void 0===r&&(r=a),e[r]=p[a]}),l=this&&this.__setModuleDefault||(Object.create?function(e,p){Object.defineProperty(e,"default",{enumerable:!0,value:p})}:function(e,p){e["default"]=p}),f=this&&this.__importStar||function(e){if(e&&e.__esModule)return e;var p={};if(null!=e)for(var a in e)"default"!==a&&Object.prototype.hasOwnProperty.call(e,a)&&r(p,e,a);return l(p,e),p},i=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(p,"__esModule",{value:!0}),p.BindingGuide=void 0;const o=f(a(57689)),n=i(a(635)),b=a(78836),t=n.default.div.attrs(({hide:e})=>({className:e?"binding-guide hide":"binding-guide"}))`
  position: fixed;
  top: 0;
  right: 0;
  bottom: 0;
...
`,g=function({rebind:e}){const[p,a]=(0,o.useState)(!0);return(0,o.useEffect)(()=>{setTimeout(()=>a(!1),300)},[]),o.default.createElement(t,{hide:p},o.default.createElement(b.GlobalStyle,null),o.default.createElement(d,null,"ACG\u52a9\u624b - \u767b\u5f55\u540e\u5373\u53ef",e?"\u91cd\u65b0":"\u81ea\u52a8","\u7ed1\u5b9a"))};p.BindingGuide=g},60671:function(e,p,a){var r=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(p,"__esModule",{value:!0});const l=r(a(57689)),f=a(97326),i=a(4783);chrome.runtime.sendMessage({command:"queryBinding"},e=>{if(!0===e){const e=document.createElement("div");e.id="root",document.body.append(e),(0,f.render)(l.default.createElement(l.default.Fragment,null,l.default.createElement(i.BindingGuide,null)),e)}}),chrome.runtime.onMessage.addListener((e,p,a)=>{"setSandBoxCookie"===e.command&&e.cookieString&&window.postMessage({command:"setSandBoxCookie",cookieString:e.cookieString},"*"),a(!0)})},748:(e,p,a)=>{Object.defineProperty(p,"__esModule",{value:!0}),p.animations=void 0;const r=a(635);p.animations=r.css`
  @keyframes blink {
    0%, to {
      color: transparent;
    }
