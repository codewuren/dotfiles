...
`},78836:(e,a,r)=>{Object.defineProperty(a,"__esModule",{value:!0}),a.GlobalStyle=void 0;const p=r(635),i=r(748),t=r(13904),l=r(43521);a.GlobalStyle=p.createGlobalStyle`
  html,body {
...
`},11120:(e,a)=>{Object.defineProperty(a,"__esModule",{value:!0}),a.opacity=void 0,a.opacity={"paper-blue-grey-900":"#263238","dark-divider-opacity":"0.12","dark-disabled-opacity":"0.38","dark-secondary-opacity":"0.54","dark-primary-opacity":"0.87","light-divider-opacity":"0.12","light-disabled-opacity":"0.3","light-secondary-opacity":"0.7","light-primary-opacity":"1.0"}},37459:(e,a,r)=>{Object.defineProperty(a,"__esModule",{value:!0}),a.theme=a.baseFontSize=void 0;const p=r(13904),i=1e3,t=204;a.baseFontSize=12,a.theme={color:p.color,logoHeight:50,bodyMinWidth:i,headerHeight:0,sidebarWidth:t,mainWidth:i-t,baseFontSize:a.baseFontSize,fontFamily:p.fontFamily,fontSize:p.fontSize,rem:p.rem,textOverflow:p.textOverflow,transition:p.transition,boxShadow:p.boxShadow,marginTrim:p.marginTrim,hideScrollbar:p.hideScrollbar,opacity:p.opacity}},13904:function(e,a,r){var p=this&&this.__createBinding||(Object.create?function(e,a,r,p){void 0===p&&(p=r);var i=Object.getOwnPropertyDescriptor(a,r);i&&!("get"in i?!a.__esModule:i.writable||i.configurable)||(i={enumerable:!0,get:function(){return a[r]}}),Object.defineProperty(e,p,i)}:function(e,a,r,p){void 0===p&&(p=r),e[p]=a[r]}),i=this&&this.__exportStar||function(e,a){for(var r in e)"default"===r||Object.prototype.hasOwnProperty.call(a,r)||p(a,e,r)},t=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(a,"__esModule",{value:!0}),a.hideScrollbar=a.marginTrim=a.transition=a.boxShadow=a.color=a.textOverflow=a.fontSize=a.fontFamily=a.rem=void 0;const l=t(r(32699)),o=r(635),n=t(r(74770)),f=r(39757);i(r(11120),a);const d=(e,a=16)=>e/a+"rem";a.rem=d;const c=(e="")=>o.css`
...
`:o.css`
    ...
    -webkit-line-clamp: ${e};
    overflow: hidden;
`;a.textOverflow=b;const g=(e,a=1)=>f.colorValues[e]?(0,n.default)(f.colorValues[e]).alpha(a).rgb().string():void 0;a.color=g;const u=([...e])=>{const a=1,r="#000000",p=.5;let i="";for(let t in e){const{h:l,v:o,blur:f,spread:d,color:c=(0,n.default)(r).alpha(p).rgb().string(),inset:s=""}=e[t];i+=`${l*a}px ${o*a}px ${5*f}px ${5*d}px ${c} ${s},`}return o.css`
        box-shadow: ${i};
    `};a.boxShadow=u;const h=({target:e="all",duration:a=.3})=>o.css`transition: ${e} ${a}s;`;a.transition=h;const _=({direction:e="h",value:a=0})=>o.css`
  &:first-of-type {
...
`},93850:function(e,a,r){var p=this&&this.__awaiter||function(e,a,r,p){function i(e){return e instanceof r?e:new r((function(a){a(e)}))}return new(r||(r=Promise))((function(r,t){function l(e){try{n(p.next(e))}catch(e){t(e)}}function o(e){try{n(p["throw"](e))}catch(e){t(e)}}function n(e){e.done?r(e.value):i(e.value).then(l,o)}n((p=p.apply(e,a||[])).next())}))},i=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(a,"__esModule",{value:!0}),a.Login=void 0;const t=r(51920),l=i(r(57689)),o=i(r(635)),n=r(96582),f=r(25336);(0,n.injectIconfont)();const d=o.default.div`
  .button {
    &.primary {
...
`;class c extends l.default.Component{constructor(e){super(e),this.handleOnClickCloseLoginModal=()=>{},this.getSessionCookie=()=>p(this,void 0,void 0,(function*(){return new Promise(e=>{chrome.runtime.sendMessage({target:"cookieController",event:"get",url:"https://www.bilibili.com/",name:"SESSDATA"},a=>{a&&e(a)})})})),this.getUID=()=>p(this,void 0,void 0,(function*(){return new Promise(e=>{chrome.runtime.sendMessage({target:"cookieController",event:"get",url:"https://www.bilibili.com/",name:"DedeUserID"},a=>{a&&e(a)})})})),this.handleOnClickLogin=()=>p(this,void 0,void 0,(function*(){const e=yield this.getUID(),a=yield this.getSessionCookie();if(!e||!a)return;const r={query:"mutation ($blid: BLID!, $cookies: String!) {\n                              bilibiliHelperAccount {\n                                login(blid: $blid, cookies: $cookies) {\n                                    bhid\n                                    bhName\n                                    blidList\n                                    identities\n                                }\n                              }\n                            }\n                            ",variables:JSON.stringify({blid:e,cookies:"SESSDATA="+a})},p=yield(0,f.sendGraphQLRequest)(r),{errors:i,data:t}=p;i&&i.length>0?this.setState(Object.assign(Object.assign({},this.store),{hasLogin:!1})):(this.setState(Object.assign(Object.assign({},this.store),{hasLogin:!0})),chrome.runtime.sendMessage({target:"bilibiliHelperAccountController",event:"loginSuccessfully"},()=>{window.close()}))})),this.handleOnClickRegister=()=>p(this,void 0,void 0,(function*(){const e=yield this.getUID(),a=yield this.getSessionCookie();if(!e||!a)return;const r={query:"mutation ($blid: BLID!, $cookies: String!) {\n                      bilibiliHelperAccount {\n                        register(blid: $blid, cookies: $cookies) {\n                          bhid\n                          boundBlid\n                          blidList\n                          identityIdList\n                        }\n                      }\n                    }",variables:{blid:e,cookies:"SESSDATA="+a}},p=yield(0,f.sendGraphQLRequest)(r),{errors:i,data:t}=p;i&&i.length>0?this.setState(Object.assign(Object.assign({},this.store),{hasLogin:!1})):(this.setState(Object.assign(Object.assign({},this.store),{hasLogin:!0})),chrome.runtime.sendMessage({target:"bilibiliHelperAccountController",event:"registerSuccessfully"}))})),this.state={hasLogin:!1,bhName:"",bhid:null,blidList:[],identities:[],hasLocalBilibiliAccountLogin:!1,hasLocalBilibiliHelperAccountLogin:!1,hasLocalBilibiliHelperAccountRegister:!1}}componentDidMount(){chrome.runtime.sendMessage({target:"bilibiliHelperAccountController",event:"getBHAccountController"},({hasLocalBilibiliHelperAccountLogin:e,hasLocalBilibiliAccountLogin:a,hasLocalBilibiliHelperAccountRegister:r})=>{this.setState({hasLocalBilibiliHelperAccountLogin:e,hasLocalBilibiliAccountLogin:a,hasLocalBilibiliHelperAccountRegister:r})}),window.addEventListener("message",e=>{})}render(){const{hasLocalBilibiliHelperAccountRegister:e,hasLogin:a}=this.state;return l.default.createElement(d,null,l.default.createElement(t.Modal,{open:!0,className:"login-modal",title:"\u8bf7\u9009\u62e9\u767b\u5f55\u65b9\u5f0f",buttons:l.default.createElement("div",{className:"footer"},l.default.createElement("p",{className:"description"},l.default.createElement("b",{style:{marginRight:4}},"\u203b"),"\u52a9\u624b\u8d26\u53f7\u4e0ebilibili\u8d26\u53f7\u5173\u8054"),l.default.createElement(t.Button,{onClick:this.handleOnClickCloseLoginModal},"\u53d6\u6d88"))},e?l.default.createElement(t.Button,{disabled:a,className:"primary",onClick:this.handleOnClickLogin},"\u7528\u5df2\u767b\u5f55\u7684",l.default.createElement(t.Icon,{size:16,icon:"bilibili"}),"\u8d26\u53f7\u767b\u5f55"):l.default.createElement(t.Button,{disabled:a,className:"primary",onClick:this.handleOnClickRegister},"\u7528\u5df2\u767b\u5f55\u7684",l.default.createElement(t.Icon,{size:16,icon:"bilibili"}),"\u8d26\u53f7\u6ce8\u518c")))}}a.Login=c}},a={};function r(p){var i=a[p];if(void 0!==i)return i.exports;var t=a[p]={id:p,loaded:!1,exports:{}};return e[p].call(t.exports,t,t.exports,r),t.loaded=!0,t.exports}r.m=e,(()=>{var e=[];r.O=(a,p,i,t)=>{if(!p){var l=1/0;for(d=0;d<e.length;d++){for(var[p,i,t]=e[d],o=!0,n=0;n<p.length;n++)(!1&t||l>=t)&&Object.keys(r.O).every(e=>r.O[e](p[n]))?p.splice(n--,1):(o=!1,t<l&&(l=t));if(o){e.splice(d--,1);var f=i();void 0!==f&&(a=f)}}return a}t=t||0;for(var d=e.length;d>0&&e[d-1][2]>t;d--)e[d]=e[d-1];e[d]=[p,i,t]}})(),(()=>{r.n=e=>{var a=e&&e.__esModule?()=>e["default"]:()=>e;return r.d(a,{a}),a}})(),(()=>{r.d=(e,a)=>{for(var p in a)r.o(a,p)&&!r.o(e,p)&&Object.defineProperty(e,p,{enumerable:!0,get:a[p]})}})(),(()=>{r.g=function(){if("object"===typeof globalThis)return globalThis;try{return this||new Function("return this")()}catch(e){if("object"===typeof window)return window}}()})(),(()=>{r.o=(e,a)=>Object.prototype.hasOwnProperty.call(e,a)})(),(()=>{r.r=e=>{"undefined"!==typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})}})(),(()=>{r.nmd=e=>(e.paths=[],e.children||(e.children=[]),e)})(),(()=>{r.j=20})(),(()=>{var e={20:0};r.O.j=a=>0===e[a];var a=(a,p)=>{var i,t,[l,o,n]=p,f=0;if(l.some(a=>0!==e[a])){for(i in o)r.o(o,i)&&(r.m[i]=o[i]);if(n)var d=n(r)}for(a&&a(p);f<l.length;f++)t=l[f],r.o(e,t)&&e[t]&&e[t][0](),e[t]=0;return r.O(d)},p=self["webpackChunkbilibilihelper2"]=self["webpackChunkbilibilihelper2"]||[];p.forEach(a.bind(null,0)),p.push=a.bind(null,p.push.bind(p))})(),(()=>{r.nc=void 0})();var p=r.O(void 0,[196,133,468],()=>r(84930));p=r.O(p)})();